...
The actual process of working with long-running branches in a collaborative setting can present some challenges, especially with regards to eventual merge conflicts when branches are merged. This can cleary be seen in the instance where, for example, two or more developers have been working on the same code and alterations have been made but this can effectively be resolved through creating pull requests with code review.
