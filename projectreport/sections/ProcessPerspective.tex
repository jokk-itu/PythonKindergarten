...
\textbf{Team organization}\newline
  ...
  with labels, such as 'need to have', 'group discussion' etc. for further classification. These same issues became the tasks that needed attention on the Projects Board.
