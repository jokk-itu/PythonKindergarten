\section{System's Perspective}
  ...
  \begin{enumerate}
    ...
    Apart from communicating with the REST API, the frontend also communicates directly with the RabbitMQ broker to send and receive private messages.
    This communication takes place over WSS using the MQTT protocol. MQTT communication is then bound to a message queue on the broker.
    ...
    Various metrics are also exposes on the API, allowing us to monitor the system externally.
